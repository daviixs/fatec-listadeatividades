...
import com.seucalendarioacademico.dto.AtividadeCalendarioResponse;
...
public class SalaConsultaService {
    ...
    public SalaCalendarioResponse buscarCalendarioPorSala(Integer salaId) {
        SalaDeAula sala = salaRepository.findById(salaId)
                .orElseThrow(() -> new com.seucalendarioacademico.exception.RecursoNaoEncontradoException("Sala nao encontrada"));
